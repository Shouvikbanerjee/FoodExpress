...
<head>
  ...
  <title>Total Delivery Partner | FoodExpress</title>
  ...
  <div class="row">
    ...
    <main class="col-md-10 ms-sm-auto main-content">
      <div class="topbar d-flex justify-content-between align-items-center mb-4">
        <h3 class="fw-bold mb-0 text-dark">👥 Total Delivery Partner</h3>
      ...
      <div class="table-responsive">
        <table class="table table-hover table-bordered align-middle rounded-3 overflow-hidden">
          ...
          <?php
          $count = 1;
          $query = mysqli_query($con, "SELECT * FROM delivery_partner ORDER BY dp_id DESC");
  ...
  <div class="modal-dialog">
    <form class="modal-content rounded-4">
      <div class="modal-header bg-primary text-white rounded-top">
        <h5 class="modal-title" id="editUserModalLabel">View Delivery Partner</h5>
