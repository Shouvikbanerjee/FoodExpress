...
<div class="d-md-none sidebar-mobile">
  ...
  <nav class="collapse" id="mobileMenu">
    ...
    <a href="order_history.php" class="<?php echo basename($_SERVER['PHP_SELF']) == 'order.php' ? 'active' : ''; ?>">
      <i class="bi bi-receipt me-2"></i> Order History
    </a>
    <a href="earning.php" class="<?php echo basename($_SERVER['PHP_SELF']) == 'menu.php' ? 'active' : ''; ?>">
